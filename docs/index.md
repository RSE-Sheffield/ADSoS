...
First, we choose an evaluation strategy and score aggregation strategy. The `EgoMinimumDistanceEvaluationStrategy` scores the scenario according to the minimum distance reached between any two ego vehicles during the simulation:
